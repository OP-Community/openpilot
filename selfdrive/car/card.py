...
class Car:
  ...
  def __init__(self, CI=None, RI=None) -> None:
    ...
    if CI is None:
      ...
      if self.params.get_bool("op_lat_alka"):
        op_params |= structs.OPFlags.LateralALKA

      self.CI = get_car(*self.can_callbacks, obd_callback(self.params), alpha_long_allowed, is_release, num_pandas, cached_params, op_params)
    ...
    if op_params & structs.OPFlags.LateralALKA:

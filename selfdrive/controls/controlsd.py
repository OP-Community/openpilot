...
class Controls:
  def __init__(self) -> None:
    ...
    self.pm = messaging.PubMaster(['carControl', 'controlsState', 'opControlsState'])
    ...
    self.alka_enabled = self.params.get_bool("op_lat_alka")
  ...
  def publish(self, CC, lac_log):
    ...
    # opControlsState
    dat = messaging.new_message('opControlsState')
    dat.valid = True
    ncs = dat.opControlsState
    ncs.alkaActive = self.alka_active
    self.pm.send('opControlsState', dat)
